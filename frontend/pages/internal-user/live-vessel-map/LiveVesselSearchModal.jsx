...
import { NAVIGATION_STATUSES } from './liveVesselMap.constants.js';
import styles from './LiveVesselSearchModal.module.css';

export default function LiveVesselSearchModal({
  open,
  latitude,
  longitude,
  radius,
  ...
  return (
    <div className={styles.backdrop} role="presentation" onClick={onClose}>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="live-vessel-search-title"
        onClick={(event) => event.stopPropagation()}
      >
        <div className={styles.header}>
          <h4 id="live-vessel-search-title">
        ...
        <div className={styles.body}>
          <div className="mb-3">
            <label className="form-label" htmlFor="live-vessel-latitude">Latitude</label>
            <input
              id="live-vessel-latitude"
              type="text"
          ...
          <div className="mb-3">
            <label className="form-label" htmlFor="live-vessel-longitude">Longitude</label>
            <input
              id="live-vessel-longitude"
              type="text"
              className="form-control"
              value={longitude}
              readOnly
          ...
          <div className="mb-3">
            <label className="form-label" htmlFor="live-vessel-radius">
              Radius <i>(in km)</i>
            </label>
            <input
              id="live-vessel-radius"
              type="number"
              className="form-control"
              value={radius}
              min="1"
