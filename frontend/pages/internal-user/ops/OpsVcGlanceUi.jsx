...
import bunkersChipIcon from '../../../assets/ops_chip_bunkers.png';
import sofChipIcon from '../../../assets/ops_chip_sof.png';
import laytimeChipIcon from '../../../assets/ops_chip_laytime.png';
import faChipIcon from '../../../assets/ops_chip_fa.png';
import cashChipIcon from '../../../assets/ops_chip_cash.png';
import daChipIcon from '../../../assets/ops_chip_da.png';
import styles from './OpsVcInOpsGlancePage.module.css';

export { DEFAULT_PAGE_SIZE, PAGE_SIZE_OPTIONS };

function ChipMaskIcon({ src }) {
  return (
    <span
...
/** Chip icons — PNG assets where provided; SVG fallback for Letters. */
...
export function DaChipIcon() {
  return <ChipMaskIcon src={daChipIcon} />;
}

export function BunkersChipIcon() {
  return <ChipMaskIcon src={bunkersChipIcon} />;
}

export function SofChipIcon() {
  return <ChipMaskIcon src={sofChipIcon} />;
}

export function LaytimeChipIcon() {
  return <ChipMaskIcon src={laytimeChipIcon} />;
}

export function CashflowChipIcon() {
  return <ChipMaskIcon src={cashChipIcon} />;
}

export function FaChipIcon() {
  return <ChipMaskIcon src={faChipIcon} />;
}
